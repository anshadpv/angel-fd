...
func (e Error) GetTrace() string {
	if e.trace == constants.EmptyString {
...
func (e *Error) GetReason() string {
	if e.Reason == constants.EmptyString {
		return e.Message
	}
	return e.Reason
}
...
func (e *Error) GetSubCategory() string {
	if e.SubCategory == constants.EmptyString {
		return e.Message
	}
...
func (e *Error) GetCategory() string {
	if e.Category == constants.EmptyString {
		return e.Message
	}
	return e.Category
}
...
func (e *Error) Error() string {
	if e.Code == constants.EmptyString {
		return e.Message
	}
	return e.Code
}
